...
static CGFloat const hudDismissAlpha = 0;

//static UIActivityIndicatorViewStyle wsIndicatorViewStyle;
...
- (void)showHUDViewWithAnimation
{
    ...
    if (self.hudView.alpha == hudDismissAlpha) {
...
- (void)dismiss
{
    ...
    [UIView animateWithDuration:0.2
                     ...
                     animations:^{
                         ...
                         self.hudView.alpha = hudDismissAlpha;
                     }
                     completion:^(BOOL finished){
                         self.hudView.transform = CGAffineTransformIdentity;
